...
export default (props) => {
    ...
    const { colors, team_full_name, team_id, id ,chooseTeam, league_name, isMobile, deleteTeam, logo, openModal } = props;
            ...
            <div className="container">
                <div className="row">
                    ...
                    {!isMobile && (
                        ...
                        <button onClick={ () => {openModal(team_id || id, team_full_name)} } className="btn btn-large col m1  red darken-3"><i className="material-icons">delete</i></button>
                    )}
                </div>
            </div>
        );
